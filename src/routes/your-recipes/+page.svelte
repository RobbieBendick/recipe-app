...
<main class="page">
	<header class="intro">
		<div class="intro__row">
			<h1>Your recipes</h1>
			<a class="btn" href="{base}/your-recipes/new">Add recipe</a>
		</div>
		<p class="lede">Everything you’ve saved — ready to cook or turn into a shopping list.</p>
	</header>
	...
	{:else if recipes.length === 0}
		<div class="empty" role="status">
			...
			<p>Add your first dish and it’ll show up in this collection.</p>
			<a class="btn" href="{base}/your-recipes/new">Add a recipe</a>
		</div>
	{:else}
		<ul class="list">
			{#each recipes as recipe (recipe.id)}
				<li>
					<a class="row" href="{base}/your-recipes/{recipe.id}">
						<span class="row__emoji" aria-hidden="true">{displayEmoji(recipe.emoji)}</span>
						<span class="row__title">{recipe.title}</span>
