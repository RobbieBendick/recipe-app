<script lang="ts">
	...
	import { loginWithGoogle, register } from '$lib/auth-api';
	...
	async function handleSubmit(event: Event) {
		...
		try {
			...
			error = e instanceof ApiError ? e.message : 'Could not create account';
		} finally {
			busy = false;
		}
	}
...
<main class="page">
	<header class="intro">
		...
		<p class="lede">Your recipes, shopping lists, and pantry — all yours.</p>
	</header>
	...
	<form class="card" onsubmit={handleSubmit}>
		...
		<label>
			<span>Name</span>
			<input bind:value={name} type="text" autocomplete="name" disabled={busy} />
		</label>
		<label>
			<span>Email</span>
		...
		<p class="switch">
			Already have an account? <a href="{base}/login">Log in</a>
		</p>
	</form>
</main>
